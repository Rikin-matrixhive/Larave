      ...
      <div class="container py-md-4">
        <div class="row footer-top-29">
          ...
          <div class="col-lg-3 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5">
            ...
            <a href="#playstore"><img src="{{ asset('images/googleplay.png') }}" class="img-responsive" alt=""></a>
            <a href="#appstore"><img src="{{ asset('images/appstore.png') }}" class="img-responsive mt-3" alt=""></a>
          </div>
        </div>
      </div>
    </div>
